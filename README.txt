This application attempts to simulate the reliable delivery services of the TCP over
the unreliable services of the UDP. 
...
Contents:
	...
	Timer.java:
		...
		- Runs concurrent to Sender and Receiver as separate thread.
	...
	Segment.java:
		...
		- Contains fields to track various segment properties.
		  (sent, ACKed, etc.)
